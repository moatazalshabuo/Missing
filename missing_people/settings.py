"""
Django settings for missing_people project.
...
SECRET_KEY = 'django-insecure-+(@31__wb^hqdr)94ureeirkw*ewnvgqi&p$3tohe(9x(hll+9'
...
ROOT_URLCONF = 'missing_people.urls'
...
WSGI_APPLICATION = 'missing_people.wsgi.application'
